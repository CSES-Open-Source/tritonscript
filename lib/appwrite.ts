...
export const STORAGE_BUCKET_ID = process.env.NEXT_PUBLIC_STORAGE_BUCKET_ID!; // Replace with your storage bucket ID
export const NOTES_COLLECTION_ID = process.env.NEXT_PUBLIC_NOTES_COLLECTION_ID!;
